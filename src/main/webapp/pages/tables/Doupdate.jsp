 <%@ page import="java.sql.*"%><%@ page import="model.Stagiaires"%>
 <%
 ...
 PreparedStatement preparedStatement = con.prepareStatement("update stagiaires set firstname=?, lastname=?, dtn=?,db_stage=?,dfin=?,email=?,encadreur=?, sujet=?"+
  "where email=?");
