          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                <form action="Doadd.jsp" method="post"><tr><td>firstname</td>
                <td><input value="" name="firstname"> </td></tr>
                <tr><td>lastname</td>
                <td><input value="" name="lastname"> </td></tr>
                <tr><td>email</td>
                <td><input value="" name="email"> </td></tr>
                <tr><td>sujet</td>
                <td><input value="" name="sujet"> </td></tr>
                <tr><td>db_stage</td>
                <td><input value="" name="db_stage"> </td></tr>
                <tr><td>dfin</td>
                <td><input value="" name="dfin"> </td></tr>
                <tr><td>dtn</td>
                <td><input value="" name="dtn"> </td></tr>
                <tr><td>encadreur</td>
                <td><input value="" name="encadreur"> </td></tr>
